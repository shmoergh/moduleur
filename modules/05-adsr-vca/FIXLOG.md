...
_Sympthom:_ the VCA output is not protected against input currents.
_Solution:_ add a 1kΩ resistor between the output jack and the output connection on the UI board.
