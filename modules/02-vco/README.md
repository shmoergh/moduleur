...
1. Connect a keyboard with CV output to the VCO. We recommend an Arturia Keystep, Beatstep Pro, Korg SQ1 or similar. Or if you have the [Brain module](https://github.com/shmoergh/moduleur/tree/main/modules/07-brain) done, you can use [Le Controlleur](https://github.com/shmoergh/le-controlleur) firmware in MIDI mode and a MIDI keyboard too.
2. Turn HI-FREQ pot all the way down: play a very high pitch note on the keyboard and turn the knob until the pitch stops going down.
